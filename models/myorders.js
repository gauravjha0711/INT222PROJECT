...
const Order = mongoose.model("Order",listingSchema) ; //name of the collections is lisitngs because first upper case letter is converted in to small and s is added to the last
